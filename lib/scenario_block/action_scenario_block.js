var all_actions = alchemy.getClassGroup('scenario_action');
 ...
 */
var Action = Function.inherits('Alchemy.Scenario.Block.Block', function Action(scenario, data) {
	Action.super.call(this, scenario, data);
});
...
Action.setMethod(function getDescription(callback) {
	...
	document = Model.get('ScenarioAction').createDocument();
