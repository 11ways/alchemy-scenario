var change_values = alchemy.shared('scenario.block_change_values');
 ...
 */
var Gate = Function.inherits('Alchemy.Scenario.Block.Aggregate', function LogicGate(scenario, data) {
	LogicGate.super.call(this, scenario, data);
});
