var all_events = alchemy.getClassGroup('scenario_event');
 ...
 */
var Event = Function.inherits('Alchemy.Scenario.Block.Block', function Event(scenario, data) {
	Event.super.call(this, scenario, data);
});
