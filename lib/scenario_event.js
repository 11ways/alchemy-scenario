 ...
 */
var Event = Function.inherits('Alchemy.Base', 'Alchemy.Scenario.Event', function Event(document) {
 ...
 */
Event.setProperty('is_abstract_class', true);
 ...
 * @type {Boolean}
 */
Event.setProperty('group_name', 'scenario_event');
